...
"""
# cd '/Users/lauraforerocamacho/Downloads/Maestria/DataWarehouses/Final/NewPrevious/tpcds-kit/tools' && ./dsqgen -DIRECTORY ../query_templates -INPUT ../query_templates/templates.lst -VERBOSE Y -QUALIFY Y -SCALE 1 -DIALECT spark -OUTPUT_DIR /tmp && cp /tmp/query_0.sql '/Users/lauraforerocamacho/Downloads/Maestria/DataWarehouses/Final/TDC-DS_BenchmarkProject/container/tpcds-image/queries_1G_Fixed.sql' && cd '/Users/lauraforerocamacho/Downloads/Maestria/DataWarehouses/Final/TDC-DS_BenchmarkProject'
# cd '/Users/lauraforerocamacho/Downloads/Maestria/DataWarehouses/Final/NewPrevious/tpcds-kit/tools' && ./dsqgen -DIRECTORY ../query_templates -INPUT ../query_templates/templates.lst -VERBOSE Y -QUALIFY Y -SCALE 1 -DIALECT spark -OUTPUT_DIR /tmp && cp /tmp/query_0.sql '/Users/lauraforerocamacho/Downloads/Maestria/DataWarehouses/Final/TDC-DS_BenchmarkProject/scripts/queries_generated/queries_1G_Fixed.sql' && ./dsqgen -DIRECTORY ../query_templates -INPUT ../query_templates/templates.lst -VERBOSE Y -QUALIFY Y -SCALE 2 -DIALECT spark -OUTPUT_DIR /tmp && cp /tmp/query_0.sql '/Users/lauraforerocamacho/Downloads/Maestria/DataWarehouses/Final/TDC-DS_BenchmarkProject/scripts/queries_generated/queries_2G_Fixed.sql' && ./dsqgen -DIRECTORY ../query_templates -INPUT ../query_templates/templates.lst -VERBOSE Y -QUALIFY Y -SCALE 4 -DIALECT spark -OUTPUT_DIR /tmp && cp /tmp/query_0.sql '/Users/lauraforerocamacho/Downloads/Maestria/DataWarehouses/Final/TDC-DS_BenchmarkProject/scripts/queries_generated/queries_4G_Fixed.sql' && cd '/Users/lauraforerocamacho/Downloads/Maestria/DataWarehouses/Final/TDC-DS_BenchmarkProject'
...
def parse_args():
    ...
    parser.add_argument("-q", "--queries-file-path", default="/queries_vol_shared/queries_1G_Fixed.sql")
    parser.add_argument("-o", "--output-file-path", default="/queries_vol_shared/queries_1G_Fixed.sql")
...
def run_queries(query_number=-1,
                queries_new=[],
                path_to_output="/queries_vol_shared/",
